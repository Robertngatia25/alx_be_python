...
match priority:
    case "high":
        if time_bound == "yes":
            ...
            reminder = f"Reminder: '{task}' is a high priority task that should be done as soon as possible."
    case "medium":
        if time_bound == "yes":
            reminder = f"Reminder: '{task}' is a medium priority task that needs to be addressed today."
        else:
            reminder = f"Reminder: '{task}' is a medium priority task that should be done soon."
    case "low":
        if time_bound == "yes":
